...
if [ -f "/Users/chimin/go/bin/moai" ]; then
	exec "/Users/chimin/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/chimin/.local/bin/moai" ]; then
	exec "/Users/chimin/.local/bin/moai" statusline < "$temp_file"
fi
